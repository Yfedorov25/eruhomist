...
export const metadata: Metadata = {
  ...
  title: "Дім на Нагірній — перша лінія до Південного Бугу, Вінниця",
  description:
    "Приватний дім 150 м² на першій лінії до Південного Бугу. Тупікова вулиця, ~4 сотки прибережної зони, " +
    "один поверх. Прокидатися від води, не від сусідів. $300 000.",
  openGraph: {
    title: "Дім на Нагірній — перша лінія до Південного Бугу",
    description: "Приватний дім 150 м² на першій лінії до ріки. Тупікова вулиця, без сусідів.",
    locale: "uk_UA",
    type: "website",
  },
};
