...
export default function Hero() {
  ...
  useGSAP(
    () => {
      ...
      // house never shifts and nothing loops/resets — the video pair drifted, removed). On touch,
      // Lenis syncTouch keeps this pinned scrub locked to the scroll position (no jump). ----
