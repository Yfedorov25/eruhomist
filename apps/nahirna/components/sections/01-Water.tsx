...
const BEATS = [
  ...
  {
    key: "b2",
    text: "Близько чотирьох соток берега — Ваші. Місце під пірс, мангал і човен, прив'язаний просто внизу.",
  },
  {
    key: "b3",
    text: "До води — 50 кроків від тераси. До найближчого сусіда — значно далі.",
  },
];
