...
export const POI: Poi[] = [
  {
    ...
    text: "Те саме озеро, заради виду на яке й будувався дім. Сім хвилин — і ви на воді.",
  },
  {
    id: "park-leontovycha",
    cat: "park",
    ...
    text: "Зелена зона за рогом. Дві хвилини пішки — ранкова кава або вечірня прогулянка.",
  },
  {
    id: "park-sushka",
    cat: "park",
    ...
    text: "Друга зелена зона поруч. Тихі алеї, простір для пробіжки чи вихідних із дітьми.",
  },
  {
    id: "next-fitness",
    cat: "sport",
    ...
    text: "Тренажерний зал за три хвилини від дому. Зранку до роботи — і вже у формі.",
  },
  {
    id: "la-cucina",
    cat: "food",
    ...
    photo: true,
    layout: { x: 0.5, z: 0.28 },
    text: "Італійська кухня з одним із найвищих рейтингів міста. Вечеря без планування наперед.",
  },
  {
    id: "lavinia",
    cat: "food",
    ...
    photo: true,
    layout: { x: 0.34, z: 0.4 },
    text: "Ресторан майже під боком — для вечері, коли не хочеться нікуди їхати.",
  },
  {
    id: "sky-park",
    cat: "mall",
    ...
    text: "Торговий центр поруч: покупки, кіно, кав’ярні — усе за кілька хвилин.",
  },
  {
    id: "befirst-kids",
    cat: "kids",
    ...
    photo: true,
    layout: { x: -0.18, z: 0.5 },
    text: "Дитячий садок із найвищим рейтингом поруч. Ранок без поспіху через усе місто.",
  },
];
